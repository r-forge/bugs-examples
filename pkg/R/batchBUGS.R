                      ...
                      WINEPATH = NULL)
{
    ...
    bugsExe <- if(is.null(getOption("OpenBUGSDir"))) {
        "OpenBUGS"
    }
    else {
        file.path(getOption("OpenBUGSDir"), "OpenBUGS")
    }
    if(.Platform$OS.type == "windows" || .Platform$pkgType == "mac.binary"){
